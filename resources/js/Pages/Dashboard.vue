            ...
            <div class="flex flex-col flex-1 w-full overflow-y-auto">
                <main class="relative z-0 flex-1 pb-8 bg-black">
                    ...
                    <div class="bg-black text-white py-8">
                        <div class="container flex flex-col md:flex-row my-12 md:my-24">
                            <div class="flex flex-col  sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
                            ...
                            <!--right items-->
                            <div class="container flex justify-end object-right place-items-center">
                                <div class="flex">
                                    <img class="h-96 w-72" :src="'/img/foto.png'" />
                                </div>
                            </div>
                        </div>
                    </div>
